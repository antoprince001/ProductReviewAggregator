...
<div class="card" style="width: 30rem;">
  ...
  <div class="card-body">
	...
	<table>
		...
		<tr>
		<td><br><label>Enter Product Name : </label></td>
	 	<td><br><input type="text" name="productName"></td>
		</tr>	
		
		<tr>
		<td><br><label>Enter Product Description : </label></td>
	 	<td><br><input type="text" name="productDesc" ></td>
		</tr>	
		
		<tr>
		<td><br><label>Enter Product Price : </label></td>
	 	<td><br><input type="number" name="price"  ></td>
		</tr>	
